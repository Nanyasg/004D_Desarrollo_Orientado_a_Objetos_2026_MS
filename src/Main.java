...
public class Main {
  ...
  static void crearPersonaje(Scanner scanner, Personaje personaje_jugador) {
    ...
    // Para que esto no sea posible, declararemos el atributo como privado
        ...
        static void elegir_tipoPersonaje() {

    String opcion_tipoPersonaje;

    boolean mantener_eleccion = true;

    Scanner scanner = new Scanner(System.in);

    while (mantener_eleccion) {

      System.out.println("Elija su tipo de personaje");
      ...
      opcion_tipoPersonaje = scanner.nextLine();
